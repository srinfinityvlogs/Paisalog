...
async function appendTransaction({ expenseType, category, amount, merchant = '', notes = '', source, rawInput = '' }) {
  return callProxy('appendTransaction', { expenseType, category, amount, merchant, notes, source, rawInput });
}
