...
async function appendTransaction({ expenseType, category, amount, merchant = '', notes = '', source, rawInput = '', rate = '', quantity = '', finalBill = '', receiptDate = '', monthTab = '' }) {
  return callProxy('appendTransaction', { expenseType, category, amount, merchant, notes, source, rawInput, rate, quantity, finalBill, receiptDate, monthTab });
}
